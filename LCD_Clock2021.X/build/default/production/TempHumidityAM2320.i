...
I2C2_Read1ByteRegister(0x5c, 0);
_delay((unsigned long)((1)*(64000000/4000.0)));

I2C2_WriteNBytes(0x5c, data, 3);
_delay((unsigned long)((2)*(64000000/4000.0)));

I2C2_ReadNBytes(0x5c, work, 8);
...
*temp = (work[4]<<8) + work[5];
*humidity = (work[2]<<8) + work[3];
}
