...
# 8 "C:\Program Files\Microchip\xc8\v2.20\pic\include\c90\time.h"
typedef long time_t;
struct tm {
int tm_sec;
int tm_min;
...
I2C2_Write1ByteRegister(0x32, 0xe0, RTC_regE & ~0x80);
_delay((unsigned long)((80)*(64000000/4000000.0)));

RTC_regF = RTC_regF & ~0x02;
I2C2_Write1ByteRegister(0x32, 0xf0, RTC_regF);
_delay((unsigned long)((80)*(64000000/4000000.0)));
...
I2C2_Write1ByteRegister(0x32, 0x80, alarmtime[0]);
_delay((unsigned long)((80)*(64000000/4000000.0)));
I2C2_Write1ByteRegister(0x32, 0x90, alarmtime[1]);
_delay((unsigned long)((80)*(64000000/4000000.0)));
I2C2_Write1ByteRegister(0x32, 0xa0, alarmtime[2]);
_delay((unsigned long)((80)*(64000000/4000000.0)));



RTC_regE = RTC_regE | 0x80;
I2C2_Write1ByteRegister(0x32, 0xe0, RTC_regE);
_delay((unsigned long)((80)*(64000000/4000000.0)));
RTC_regF = RTC_regF & ~0x02;
I2C2_Write1ByteRegister(0x32, 0xf0, RTC_regF);
_delay((unsigned long)((80)*(64000000/4000000.0)));
...
I2C2_Write1ByteRegister(0x32, 0x00, datetime[0]);

_delay((unsigned long)((80)*(64000000/4000000.0)));
I2C2_Write1ByteRegister(0x32, 0x10, datetime[1]);
_delay((unsigned long)((80)*(64000000/4000000.0)));
I2C2_Write1ByteRegister(0x32, 0x20, datetime[2]);
_delay((unsigned long)((80)*(64000000/4000000.0)));
}

# 163
void RTC_setDate(uint8_t *datetime) {
I2C2_Write1ByteRegister(0x32, 0x30, datetime[3]);
_delay((unsigned long)((80)*(64000000/4000000.0)));
I2C2_Write1ByteRegister(0x32, 0x40, datetime[4]);
_delay((unsigned long)((80)*(64000000/4000000.0)));
I2C2_Write1ByteRegister(0x32, 0x50, datetime[5]);
_delay((unsigned long)((80)*(64000000/4000000.0)));
I2C2_Write1ByteRegister(0x32, 0x60, datetime[6]);
_delay((unsigned long)((80)*(64000000/4000000.0)));
}
...
I2C2_ReadDataBlock(0x32, 0x00, datetime, 7);
}
...
RTC_regE = I2C2_Read1ByteRegister(0x32, 0xe0);

RTC_regF = I2C2_Read1ByteRegister(0x32, 0xf0);
...
# 282
if ((RTC_regF & (0x40 | 0x20 | 0x10)) == 0x20) {
...
I2C2_Write1ByteRegister(0x32, 0x70, 0x00);

I2C2_Write1ByteRegister(0x32, 0x80, 0x00);
I2C2_Write1ByteRegister(0x32, 0x90, 0x00);
I2C2_Write1ByteRegister(0x32, 0xa0, 0x00);

I2C2_Write1ByteRegister(0x32, 0xb0, 0x00);
I2C2_Write1ByteRegister(0x32, 0xc0, 0x00);
