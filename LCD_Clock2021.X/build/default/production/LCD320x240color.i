...
# 34 "LCD320x240color.c"
uint16_t global_bg_color = 0x0000;
...
uint8_t line = Font.font[8+ fontXsize * (c - Font.offset) + i];
if (c == ' ') line = 0;
...
Cursor_x += pitchX;
if ( Cursor_x > (320 + pitchX) ) Cursor_x = 320;
if (wrap && (Cursor_x + pitchX) > 320) {
Cursor_x = 0;
Cursor_y += textsizeY * fontYsize;
if ( Cursor_y > (240 + pitchY) )
Cursor_y = 240;
}
...
bool steep = (((int16_t)(y1 - y0)) < 0 ? -((int16_t)(y1 - y0)) : ((int16_t)(y1 - y0))) > (((int16_t)(x1 - x0)) < 0 ? -((int16_t)(x1 - x0)) : ((int16_t)(x1 - x0)));
